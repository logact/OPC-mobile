...
当前 iOS Bundle Identifier 已设为 `com.logat.utralTodo`（与 App Store Connect 现有 App 记录保持一致），Android package 仍为 `com.logact.utralTodo`。
...
4. 配置 iOS 凭证：
   ...
   - 创建/复用 App ID `com.logat.utralTodo`
   - 创建 Distribution 证书
